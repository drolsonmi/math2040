...
<title>Lecture 23: ANOVA</title></head>
...
$$MSE = \frac{SS_E}{df_E} = \frac{\sum(x-\bar{x})^2}{df_E} = s^2$$

* $SS_E$ is the sum of squares within groups
* $df_E = n - k$
...
$$MSG = \frac{SS_G}{df_G} = \frac{\sum n(\bar{x}_i - GM)}{df_G}$$

* $SS_G$ is the sum of squares between groups
...
## Helps
* [ANOVA Example Worksheet]()

## Exercises
1. Exercise 7.35 from section 7.5 exercises
2. Exercise 7.38 from section 7.5 exercises 
...
3. Exercise 7.39 from section 7.5 exercises
4. Exercise 7.44 from section 7.5 exercises
5. Exercise 7.43 from section 7.5 exercises
6. Exercise 7.54 from chapter 7 exercises