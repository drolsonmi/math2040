...
>   * What's the probability that person 2 does not share birthdays with person 1? $\frac{364}{365}$
>   * What's the probability that person 3 does not share birthdays with person 1 or 2? $\frac{363}{365}$
>   * What's the probability that person 3 does not share birthdays with anyone in the roomperson 1 or 2? $\frac{363}{365}$
...
>    * 2 people in a room. Probability that person 2's birthday is not on person 1's birthday: 
>       * $P(1^C) = \frac{364}{365} = 0.997$
>    * 3 people in a room. Probability that person 3's birthday is not on person 1's or person 2's birthdays:
>       * $P(1^C~and~2^C) = P(2^C|1^C)P(1^C) = \frac{363}{364}\frac{364}{365} = \frac{363}{365} = 0.995$
>    * 4 people in a room. $P(1^C~and~2^C~and~3^C) = P(3^C|1^C~and~2^C)P(1^C~and~2^C) = \frac{362}{363}\frac{363}{365} = \frac{362}{365} = 0.992$
>    * 5 people in a room. $P(1^C~and~2^C~and~3^C~and~4^C) = \frac{361}{365} = 0.989$
>    * ...
